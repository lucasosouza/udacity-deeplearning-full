...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        # print(delta_weights_h_o.shape, output_error_term.shape, hidden_outputs.shape)
        delta_weights_h_o += np.dot(hidden_outputs[:, None], output_error_term[:, None].T)
        # print(delta_weights_i_h.shape, hidden_error_term.shape, X.shape)
